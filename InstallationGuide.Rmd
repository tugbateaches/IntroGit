...
- Mac: Oepn the terminal (open the Spotlight Search and type Terminal) and type `git --version` to see if Git is already installed. If this returns nothing or an error, visit [this website](www.git-scm.com) and install Git. If it is confusing, you can watch this [video-tutorial](https://youtu.be/sJ4zr0a4GAs).
...
- Linux: Open the terminal and type the following:
...
Done? Great! Now, you need to let Git know about your GitHub account. Open Git and type the following:
